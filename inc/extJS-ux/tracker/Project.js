DA.Tracker.Project = function(config) {
	...
	DA.Tracker.Project.superclass.constructor.call(this, config);
};

Ext.extend(DA.Tracker.Project, DA.Tracker.Form, {
	...
	cm: function() {
		var cm = new Ext.ux.grid.ColumnModel([
			{ header: 'Project', dataIndex: 'DisplayValue', width: 100 }
        ]);
	...
	configureListTab: function(config) {
		...
		this.projectUserGrid = DA.Tracker.ProjectUser.createGrid({ title: 'User', allowPaging: true, editable: true });
...
DA.Tracker.Project = new DA.Tracker.Project();
