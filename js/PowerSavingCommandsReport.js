Cooler.PowerSavingCommandsReport = Ext.extend(Cooler.Form, {

	controller: 'PowerSavingCommandsReport',

	keyColumn: 'SmartDeviceCommandId',

	title: 'Power Saving Commands Report',

	disableAdd: true,

	disableDelete: true,
	securityModule: 'PowerSavingCommandsReport',
	constructor: function (config) {
		Cooler.PowerSavingCommandsReport.superclass.constructor.call(this, config || {});
...
Cooler.PowerSavingCommandsReport = new Cooler.PowerSavingCommandsReport({ uniqueId: 'PowerSavingCommandsReport' });