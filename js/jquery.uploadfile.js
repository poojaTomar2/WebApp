    ...
    $.fn.uploadFile = function (options) {
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
            	...
            	var form = $("<form style='display:block; position:absolute;left: 150px;' class='" + obj.formGroup + "' method='" + s.method + "' action='" + s.url + $('#coolerProductId').val() + "' enctype='" + s.enctype + "'></form>");
                form.appendTo('body');
                var fileArray = [];
