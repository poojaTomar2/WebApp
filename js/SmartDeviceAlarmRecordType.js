Cooler.SmartDeviceAlarmRecordTypeC1 = Ext.extend(Cooler.Form, {
	controller: 'SmartDeviceAlarmTypeRecord',
	keyColumn: 'SmartDeviceAlarmTypeRecordId',
	title: 'Machine Alarm',
	disableAdd: true,
	securityModule: 'SmartDeviceAlarmTypeRecord',
	disableDelete: true,
	constructor: function (config) {
		Cooler.SmartDeviceAlarmRecordTypeC1.superclass.constructor.call(this, config || {});
		Ext.apply(this.gridConfig, {
			multiLineToolbar: true,
			custom: {
				loadComboTypes: true
			},
			defaults: { sort: { dir: 'DESC', sort: 'SmartDeviceAlarmTypeRecordId' } }
		});
	},
	comboTypes: [
		'TimeZone'
	...
	hybridConfig: function () {
		return [
			{ dataIndex: 'SmartDeviceAlarmTypeRecordId', type: 'int', header: 'Id', align: 'right' },
			{ header: 'Alarm Type', dataIndex: 'AlarmType', type: 'string' },
...
Cooler.SmartDeviceAlarmRecordType = new Cooler.SmartDeviceAlarmRecordTypeC1({ uniqueId: 'SmartDeviceAlarmRecordType' });
Cooler.SmartDeviceAlarmRecordTypeReadOnly = new Cooler.SmartDeviceAlarmRecordTypeC1({ uniqueId: 'SmartDeviceAlarmRecordTypeReadOnly' });
