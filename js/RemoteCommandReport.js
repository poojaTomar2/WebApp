Cooler.RemoteCommandReport = Ext.extend(Cooler.Form, {

	controller: 'RemoteCommandReport',

	keyColumn: 'SmartDeviceCommandId',

	title: 'Remote Command Report',

	disableAdd: true,

	disableDelete: true,
	securityModule: 'RemoteCommandReport',
	constructor: function (config) {
		Cooler.RemoteCommandReport.superclass.constructor.call(this, config || {});
	...
	hybridConfig: function () {
		return [
			...
			{ header: 'CoolerIot Client', type: 'string', dataIndex: 'Client', width: 150 },
			...
			{ header: 'Value', type: 'string', dataIndex: 'Value', width: 150 },
...
Cooler.RemoteCommandReport = new Cooler.RemoteCommandReport({ uniqueId: 'RemoteCommandReport' });