...
markers: [{
	...
	initComponent: function () {
		...
		if (window.google && window.google.maps) {
			...
			this.buildScriptTag('http://maps.google.com/maps/api/js?sensor=false&callback=gmapapiready&key=AIzaSyBendOvnoB4eztncNWzctNywqbtYx4n_eA');
		}
...
buttons: [
	...
	mapDirection: function (request) {
		if (request) {
			var rendererOptions = { map: this.getMap() };
