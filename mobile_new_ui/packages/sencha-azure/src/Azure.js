/**
 * The Ext.Azure class provides access to Microsoft Azure Mobile services from your Sencha
...
Ext.define('Ext.azure.Azure', {
    ...
    version : '1.0.0.180.20140903154215',
    ...
    config : {
        ...
        /**
         * @cfg {String} appUrl
         * The application url as specified in your Microsoft Azure app setup.
         */
        appUrl : null,
     ...
     * @param options.useHeaderAuthentication {Boolean} true to force the use of header authentication
    ...
    invokeApi : function (options) {
        ...
        if (options.useHeaderAuthentication) {
